...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-07-2024 a las 19:18:17
...
(7, '¿Quién escribió “La divina comedia”?', 1, 'Facil', '2024-06-22 15:58:39'),
(8, 'Según el cuento de \"El Principito\", ¿cuál fue el séptimo planeta que visitó?', 1, 'Facil', '2024-06-22 15:58:39'),
...
(12, '¿Quién era la diosa de la sabiduría en la mitología griega?', 1, 'Facil', '2024-06-22 15:58:39'),
...
(23, '¿Qué fuerza nos mantiene en la superficie de la Tierra?', 2, 'Facil', '2024-06-22 15:58:39'),
...
(30, '¿Qué órgano es responsable de bombear sangre por todo el cuerpo?', 2, 'Facil', '2024-06-22 15:58:39'),
...
(43, '¿Qué selección de fútbol ha ganado más Mundiales?', 3, 'Facil', '2024-06-22 15:58:39'),
...
(48, '¿Cuál es la distancia oficial de una maratón?', 3, 'Facil', '2024-06-22 15:58:39'),
...
(51, '¿Quién es el autor de la famosa novela \"Cien años de soledad\"?', 4, 'Facil', '2024-06-22 15:58:39'),
(52, '¿Cuál es la serie de televisión más vista de todos los tiempos?', 4, 'Facil', '2024-06-22 15:58:39'),
(53, '¿Quién interpretó el papel de Harry Potter en las películas basadas en los libros de J.K.Rowling?', 4, 'Facil', '2024-06-22 15:58:39'),
(54, '¿Cuál es la película más taquillera de todos los tiempos?', 4, 'Facil', '2024-06-22 15:58:39'),
(55, '¿Quién es el actor principal en la película \"El Padrino\"?', 4, 'Facil', '2024-06-22 15:58:39'),
...
(66, '¿Qué montaña es la más alta del mundo?', 5, 'Facil', '2024-06-22 15:58:39'),
...
(69, '¿Qué país africano es conocido como la \"cuna de la humanidad\" por sus importantes hallazgos arqueológicos?', 5, 'Facil', '2024-06-22 15:58:39'),
...
(72, '¿Cuál es el nombre del satélite argentino que fue lanzado al espacio en 1948?', 5, 'Facil', '2024-06-22 15:58:39'),
...
(77, '¿En qué año Cristóbal Colón llegó a América?', 6, 'Facil', '2024-06-22 15:58:39'),
...
(82, '¿Quién fue el primer hombre en caminar sobre la Luna?', 6, 'Facil', '2024-06-22 15:58:39'),
...
CREATE TABLE `usuario` (
  ...
  `rol` enum('admin','user','editor') NOT NULL DEFAULT 'user',
  `fecha_creacion` datetime DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
